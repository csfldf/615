...
public class fineUploadAction extends ActionSupport
{

	private static final long serialVersionUID = 1L;
	private static final File UPLOAD_DIR = new File("C:\\Users\\jiadongy\\Documents\\615_2014\\project\\615Project\\uploads");
    private static File TEMP_DIR = new File("C:\\Users\\jiadongy\\Documents\\615_2014\\project\\615Project\\uploadsTemp");

    private static String CONTENT_LENGTH = "Content-Length";
    private static int SUCCESS_RESPONSE_CODE = 200;
    
    public fineUploadAction(){
    	//UPLOAD_DIR.mkdirs();
    }
...
//            log.warn("couldn't find or delete " + uuid);
            System.out.println("couldn't find or delete " + uuid);
        }
        else
        {
...
//            resp.addHeader("Access-Control-Allow-Origin", "*");
            ...
            {
                MultipartUploadParser multipartUploadParser = new MultipartUploadParser(req, TEMP_DIR, ServletActionContext.getServletContext());
...
//            log.error("Problem handling upload request", e);
        	System.out.println("Problem handling upload request : "+e.getLocalizedMessage());
...
//                    log.warn("Expected file {} to be {} bytes; file on disk is {} bytes", new Object[] { out.getAbsolutePath(), expectedFileSize, 1 });
                    System.out.println("Expected file "+out.getName()+" to be "+expectedFileSize+" bytes; file on disk is "+bytesWrittenToDisk+" bytes");
                	out.delete();
