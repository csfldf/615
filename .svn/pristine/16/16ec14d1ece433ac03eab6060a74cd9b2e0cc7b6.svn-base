/**
  ...
  *
  */
define(["avalon","text!./avalon.tab.html", "text!./avalon.tab.panels.html", "text!./avalon.tab.close.html", "css!./avalon.tab.css"], function(avalon, template, panelTpl, closeTpl) {
